...
export const categorizedComponentsList = {
    ...
    imagesAndIcons: [
        ...
        { name: 'AvatarGroup', path: '/components/avatar-group', description: 'Compact displays of multiple user avatars.' },
        { name: 'Badge', path: '/components/badge', description: 'Small labeling or indicator for status, notifications, or counts.' },
        { name: 'StatusDot', path: '/components/status-dot', description: 'Colored dot for indicating status at a glance.' },
    ],
    feedbackIndicators: [
        ...
        { name: 'ProgressBar', path: '/components/progress-bar', description: 'Visual indicator of operation or process completion.' },
    ...
    utilities: [
        { name: 'SearchBar', path: '/components/search-bar', description: 'Input field for searching content within the application.' },
