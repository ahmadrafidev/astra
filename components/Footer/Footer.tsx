...
const Footer: React.FC = () => {
    return (
        <footer className="flex flex-col sm:flex-row py-4 md:py-8 w-full items-center px-6 md:px-16 bg-gray-50 dark:bg-black justify-between" aria-label="Main Footer">
