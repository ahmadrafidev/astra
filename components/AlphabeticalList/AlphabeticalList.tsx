        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            {sortedComponentList.map((item) => (
                <Link
                    key={item.name}
                    href={item.path}
                    className="block border p-4 rounded-lg transition-all duration-300 bg-zinc-50 dark:dark:bg-zinc-800/90 hover:shadow-lg hover:bg-zinc-100 dark:hover:bg-zinc-900 dark:border-gray-700"
                >
                    <div>
