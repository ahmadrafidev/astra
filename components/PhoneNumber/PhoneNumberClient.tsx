...
const PhoneNumberClient: React.FC = () => {
    const tocItems = [
            ...
            <div className="flex">
                <div className="w-4/5 pr-2">
                    ...
                    <div id="overview" className="flex flex-col mb-5 scroll-mt-16">
                        <h1 className="text-2xl md:text-3xl font-semibold mb-2 text-gray-900 dark:text-gray-50">Phone Number</h1>
                    ...
                    <section id="best-practices" className="scroll-mt-20">
                        ...
                        <div className="space-y-4">
                            <ul className="list-decimal list-inside text-gray-700 dark:text-gray-300 space-y-3">
                                <li>Ensure the country code is clearly visible to avoid confusion.</li>
                                <li>Validate the phone number format according to the selected country.</li>
                                <li>Provide feedback if the number entered is invalid.</li>
                            </ul>
                        </div>
                    </section>
                </div>
...
PhoneNumberClient.displayName = "PhoneNumberClient";
