...
const AboutPage: React.FC = () => {
    return (
        <Layout>
            ...
            <h1 className="text-lg md:text-2xl font-medium mb-3">About Astra UI</h1>
            ...
            <h2 className="text-xl md:text-2xl font-medium mb-4">Purpose of Astra UI</h2>
            <p className="text-sm md:text-base mb-4 leading-relaxed">
            ...
            <h2 className="text-xl md:text-2xl font-medium mb-4">Principles Behind Astra UI</h2>
