                ...
                <div className="flex">
                    <div className="w-full md:w-4/5 pr-2">
                        ...
                        <section id="overview" className="mb-3 md:mb-4 scroll-mt-20">
                            <h1 className="text-2xl md:text-3xl font-semibold mb-4 text-gray-900 dark:text-gray-50">Content Standard</h1>
                        ...
                        <section id="practical-examples" className="scroll-mt-20">
