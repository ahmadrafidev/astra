...
const AboutAstraPage: React.FC = () => {
    return (
        <Layout>
            <h1 className="text-2xl md:text-3xl font-medium mb-4 text-gray-900 dark:text-white">Astra UI Overview</h1>
                        ...
                        <div key={item.name} className="border p-4 rounded-lg hover:shadow-lg transition-shadow">
                            ...
                            <Link href={item.path}>
                                <p className="text-sm font-normal text-gray-900 dark:text-gray-100 mt-2 leading-loose">
                                    ...
                                    {item.name === 'A11y' && 'Discover the core philosophy behind Astra UI and how it aims to make development easier and more accessible.'}
                                    {item.name === 'Content Standards' && 'Discover the core philosophy behind Astra UI and how it aims to make development easier and more accessible.'}
                                </p>
                            </Link>
                        </div>
                    ))}
