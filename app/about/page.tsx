        ...
        <Layout>
            ...
            <div className="mb-8 text-justify">
                <section className="mb-3 md:mb-4">
                    ...
                    <p className="text-sm md:text-base text-gray-900 dark:text-gray-50 leading-5">
                ...
                <section className="mb-3 md:mb-4">
                    ...
                    <ul className="text-gray-900 dark:text-gray-50 space-y-3 md:space-y-4">
                        ...
                        <li>
                            ...
                            <p className="text-base font-sans font-normal">Built on top of <a href="https://react-spectrum.adobe.com/react-aria/" className="text-blue-500">React Aria</a>, AstraUI prioritizes accessibility, ensuring all users can interact seamlessly.</p>
                        </li>
                        <li>
                ...
                <section className="flex flex-col">
                    ...
                    <p className="text-sm md:text-base mb-4 text-gray-900 dark:text-gray-50 font-sans leading-5">
